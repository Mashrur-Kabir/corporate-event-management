...
const Features = ({data}) => {
    ...
    return (
        <Link to={`/data/${id}`} className='bg-white rounded-lg cursor-pointer flex items-center gap-6 border px-6 py-10 shadow-xl transition-shadow duration-300 hover:shadow-none' data-aos="zoom-out">
            <div>
