...
const Footer = () => {
    return (
        <div className='bg-indigo-950'>
            <div className='flex items-end justify-between py-6 px-10 cursor-pointer max-w-7xl mx-auto'>
                {/* about and follow us */}
                <div className='space-y-6 max-w-lg'>
                    <div className="flex items-center gap-3 mb-8">
                        <img src={logo} alt="Corporex Logo" className="w-11 h-11" />
                        <h2 className="font-ubuntu font-semibold text-3xl text-white custom-underline">Corporex</h2>
                    </div>
                    <p className='font-poppins text-gray-400'>We specialize in hosting exceptional corporate events, offering a wide range of services tailored to meet the unique needs of each client. We excel in delivering memorable events across various industries. Our commitment to innovation and attention to detail ensures successful outcomes.</p>
                    <div className='flex items-center gap-2'>
                        ...
                        <a className='bg-slate-600 p-2 hover:bg-pink-600 hover:animate-rotateTwice transition-colors' href="https://dribbble.com/">
                            <IoBasketballOutline className='text-gray-300' />
                        </a>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-start gap-5 cursor-pointer">
                    ...
                    <p className='font-poppins font-medium flex items-center gap-3 text-white hover:text-custom-pink'><LuPhoneCall className='text-2xl' />+1-345-5678-77</p>
                    <p className='font-poppins font-medium flex items-center gap-3 text-white hover:text-custom-pink'><LuMailCheck className='text-2xl' />support@example.com</p>
